...
HD_PWD='/home/tibo36/Documents/Info-SI/Master/M1S1/AEO/TP_8.1/Basys3V6/Basys3V6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3V6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys3V6.tcl
