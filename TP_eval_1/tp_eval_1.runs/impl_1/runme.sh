...
HD_PWD='/home/tibo36/Documents/Info-SI/Master/M1S1/AEO/TP_eval_1/tp_eval_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eval1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eval1.tcl -notrace
