...
HD_PWD='/home/tibo36/Documents/Info-SI/Master/M1S1/AEO/TP_eval_1/tp_eval_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eval1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eval1.tcl
