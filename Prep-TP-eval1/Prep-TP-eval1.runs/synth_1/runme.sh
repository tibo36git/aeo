...
HD_PWD='/home/tibo36/Documents/Info-SI/Master/M1S1/AEO/Prep-TP-eval1/Prep-TP-eval1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm7seg.tcl
