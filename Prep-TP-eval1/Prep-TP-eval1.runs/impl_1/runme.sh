...
HD_PWD='/home/tibo36/Documents/Info-SI/Master/M1S1/AEO/Prep-TP-eval1/Prep-TP-eval1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm7seg.tcl -notrace
