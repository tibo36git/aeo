...
HD_PWD='/home/tibo36/Documents/Info-SI/Master/M1S1/AEO/TP_1/TP_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add4.tcl -notrace
