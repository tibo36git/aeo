...
HD_PWD='/home/m1/foiche/aeo/aeo/TP_1/TP_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_addv2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_addv2.tcl -notrace
