...
HD_PWD='/home/tibo36/Documents/Info-SI/Master/M1S1/AEO/TP_5/TP_5_1.1/TP_5_1.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MooreParity.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MooreParity.tcl
