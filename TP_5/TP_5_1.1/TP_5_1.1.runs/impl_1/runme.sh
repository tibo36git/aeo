...
HD_PWD='/home/tibo36/Documents/Info-SI/Master/M1S1/AEO/TP_5/TP_5_1.1/TP_5_1.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MooreParity.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MooreParity.tcl -notrace
